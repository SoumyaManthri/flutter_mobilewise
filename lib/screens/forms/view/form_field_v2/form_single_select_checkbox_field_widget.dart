          ...
          children: [
            Padding(
              ...
              child: Checkbox(
                ...
                fillColor: (value == false)? MaterialStateProperty.all<Color>(Colors.red):MaterialStateProperty.all<Color>(HexColor(AppState.instance.themeModel.primaryColor)) ,
      ...
      children: [
        Padding(
          ...
          child: Checkbox(
            ...
            fillColor: (selectedValue != "true")? MaterialStateProperty.all<Color>(Colors.transparent):MaterialStateProperty.all<Color>(HexColor(AppState.instance.themeModel.primaryColor)) ,
            checkColor: Colors.black,
            side: BorderSide(
            ...
            /*shape: RoundedRectangleBorder(
              side: BorderSide(
                color: formFieldValue != null && formFieldValue.value == selectedValue
                    ? Colors.black  // Change this to your desired border color
        ...
        Expanded(
          child: Text(
            widget.field.label,
            style: constants.normalDynamicTextStyle,
            maxLines: 3,
          ),
        ),
      ],

...
class _AppDrawerWidgetState extends State<AppDrawerWidget> {
      ...
      child: Container(
        ...
        children: [
          ...
          widget.menuList.isNotEmpty
              ? Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: _getListFromHomeContent(context),
                )
              : const SizedBox(),
          widget.menuList.isNotEmpty
              ? Padding(
  ...
  _getListFromHomeContent(BuildContext context) {
  ...
  _onPressed(FrameworkFormField menu, BuildContext context) {
    if (widget.viewModel.scaffoldKey.currentState!.isDrawerOpen! && menu.label.toLowerCase() != constants.logout.toLowerCase()) {

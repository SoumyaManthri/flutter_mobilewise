...
class _FormScannerFieldWidgetState extends State<FormScannerFieldWidget> {
  ...
  InputDecoration borderOutlined() {
    return InputDecoration(
        ...
        floatingLabelStyle: TextStyle(
            color: HexColor(AppState.instance.themeModel.primaryColor)),
        labelStyle: TextStyle(color: HexColor(AppState.instance.themeModel.textColor) ),
  ...
  sufficIcon() {
    return IconButton(
      icon:  Icon(Icons.qr_code_scanner, color: HexColor(AppState.instance.themeModel.textColor)),
      onPressed: () {

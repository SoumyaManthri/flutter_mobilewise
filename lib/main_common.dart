...
import 'package:flutter_mobilewise/screens/printer/printer_view.dart';
      ...
      providers: [
        ...
        ChangeNotifierProvider(
          create: (_) => FormViewModel(
              repo: locator<FormRepository>(),
              loginRepo: locator<LoginRepository>()),
        ),
        ChangeNotifierProvider(
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        constants.previewScreen: (context) => const FormPreviewFragmentWidget(),
        constants.printerRoute: (context) => const PrinterView(),
      },
    );
  }
}

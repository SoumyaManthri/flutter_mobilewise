...
import 'package:flutter_mobilewise/utils/styling.dart';
import 'package:flutter_mobilewise/utils/validation_util.dart';
...
const String applicationPagesEndpoint = 'v1/applicationPages';
...
const String customPage = 'CustomPage';
const String peripheralsPage = 'peripherals';
...
const String printerRoute = '/printerRoute';
...
const int hintTextColor = 0xFF707B7C;
const int lightThemeTextColor = 0xFF000000;
const int darkThemetextColor = 0xFFC3C2D9;
const String labelTextColor = "707B7C";
...
const String startTracking = 'Start Tracking';
const String stopTracking = 'Stop Tracking';
...
const String videoDialogCamera = 'Record from Camera';
const String videoDialogGallery = 'Upload from Gallery';
...
const String printerZPLMissing = 'Label design is not configuration';
...
const String geofence = 'geofence';
const String geofenceShapePoint = 'point';
const String geofenceShapeLine = 'line';
const String geofenceShapePolygon = 'polygon';
const String geofenceTypeManual = 'manual';
const String geofenceTypeWalking = 'walking';
...
const String dataListImagePicker = "image";
...
TextStyle normalDynamicTextStyle = TextStyle(
  fontSize: 16,
...
mandatoryField(FrameworkFormField field) {
  return RichText(
    text: TextSpan(
      text: field.label,
      // style: TextStyle(color: Color(AppState.instance.textHexColor)),
      style: applyStyle(field.style),
      children: <TextSpan>[
        // Red * to show if the field is mandatory
        TextSpan(
          text: ValidationUtil.isMandatory(field.validations) ? ' *' : '',
...
mandatoryFieldV2(WidgetInfo widgetInfo) {
  return RichText(
    text: TextSpan(
      text: widgetInfo.widgetLabel,
      // style: TextStyle(color: Color(AppState.instance.textHexColor)),
      style: Styling.applyStyle(widgetInfo.widgetConfig.style),
      children: <TextSpan>[
        // Red * to show if the field is mandatory
        TextSpan(
          text:
              ValidationUtil.isMandatoryV2(widgetInfo.widgetConfig.validations)
                  ? ' *'
                  : '',
          style: normalRedTextStyle,
        ),
...
// Button Styles
ButtonStyle buttonFilledStyle({required Color backgroundColor}) {
...
ButtonStyle buttonOutlineStyle({required Color backgroundColor}) {
  return OutlinedButton.styleFrom(
    shape: const StadiumBorder(),
    side: BorderSide(width: 2.0, color: backgroundColor),
  );
}
...
const String videoUpload = 'video';
const String imageUpload = 'image';
const String imageWithDirection = 'imgDirection';
const String notUploadedVideo = 'Not uploaded any video';
const String videoUrl = 'video';
const String thumbnailUrl = 'thumbnail';
const String videoPreview = 'Video Preview';

...
class NavigationUtil {
  ...
  navigateToImagePreviewScreen(
      BuildContext context, FormImageFieldWidgetMedia formImageFieldWidgetMedia) {
    Navigator.pushNamed(context, constants.imagePreviewRoute,
        arguments: ImagePreviewArguments(formImageFieldWidgetMedia));
  }
  ...
  navigateToPrinterScreen(BuildContext context) {
    Navigator.pushNamed(context, constants.printerRoute);
  }

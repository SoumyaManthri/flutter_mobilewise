...
import '../screens/forms/view/form_field_v2/form_date_range_widget.dart';
...
import '../screens/forms/view/form_field_v2/form_field_geofence_values_widget.dart';
...
import '../screens/forms/view/form_field_v2/form_geofence_field_widget.dart';
  ...
  Widget getFormFieldWidget(FrameworkFormField field, FormViewModel viewModel,
    ...
    if (field.uiType == constants.dropdown) {
      ...
      for (PageForm pageForm in forms) {
        List<WidgetInfo>? widgets = pageForm.widgets;
        for (WidgetInfo widgetInfo in widgets) {
      ...
      return FormSubformFieldWidget(
        ...
        field.uiType == constants.printer) {
      /// Form field button and printer
    ...
    } else if (field.uiType == constants.geofence) {
      /// Geofence widget
      return FormGeofenceFieldWidget(
        key: Key(field.key),
        field: field,
        viewModel: viewModel,
      );

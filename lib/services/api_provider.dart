...
import 'package:flutter_mobilewise/screens/forms/view_model/form_view_model.dart';
...
class ApiProvider {
  ...
  getPages() async {
    ...
    List<PageInfo> forms;
    try {
      forms = await client.getForms();
      FormViewModel.setFormPages(forms);
      /*if (forms.statusCode != null &&
          forms.statusCode == 200 &&
          forms.response != null) {
        AppState.instance.setTheme(forms.response!.theme);
      } else if (forms.statusCode != null &&
          forms.statusCode == 401) {
        Util.instance
            .logMessage('App sync service', 'Error while parsing theme');
      }*/
      Util.instance.logMessage('GET FORMS',
          'FORM FETCHED');

...
import '../model/theme_model/theme_result.dart';
    ...
    if (hiveMediaEntries.isNotEmpty) {
      ...
      for (FormMediaModel mediaFileEntry in hiveMediaEntries) {
        ...
        if (await media.exists()) {
          ...
          String imageUrl = await ImageUploadProvider().uploadMediaToS3(media);
  ...
  getTheme() async {
    ...
    try {
      ...
      if (themeResult.statusCode != null &&
        ...
        Util.instance
            .logMessage('App sync service', 'Error while parsing theme');
      }
    } on dio.DioException catch (e) {
      Util.instance.logMessage('App sync service: Dio Exception',
          'Error while fetching theme -- $e');
    } catch (e) {
      Util.instance.logMessage(
          'App sync service: catch', 'Error while fetching theme -- $e');
    }
  }
}

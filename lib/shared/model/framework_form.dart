...
class FrameworkForm {
  ...
  List<FrameworkFormField> navBar;
...
class FrameworkFormField {
  ...
  factory FrameworkFormField.fromJson(Map<String, dynamic> json) {
    ...
    AdditionalConfig additionalConfigValue = AdditionalConfig(
        dateFormat: '', maxDateRange: 0, minDateRange: 0, fileType: []);
    if (json['additionalConfig'] != null) {
      additionalConfigValue =
          AdditionalConfig.fromJson(json['additionalConfig']);
    }
    ...
    if (json['fileType'] != null) {
      fileTypeList = List<String>.from(json['fileType']);
    }
    ...
    return FrameworkFormField(
        ...
        style: style,
        additionalConfig: additionalConfigValue,
...
class AdditionalConfig {
  ...
  String? uploadType;
  String? geofenceShape;
  String? geofenceTypes;
  ...
  factory AdditionalConfig.fromJson(Map<String, dynamic> json) {
    List<String> fileType = <String>[];
    if (json['fileType'] != null) {
      fileType = (json['fileType'] as List<dynamic>).cast<String>();
    }

    List<String> allowedVideoTypesList = <String>[];
    if (json['allowedVideoTypes'] != null) {
      allowedVideoTypesList =
          (json['allowedVideoTypes'] as List<dynamic>).cast<String>();
    }

    return AdditionalConfig(
      dateFormat: json['dateFormat'] ?? '',
      maxDateRange: json['maxDateRange'],
      minDateRange: json['minDateRange'],
      fileType: fileType,
      allowedVideoTypes: allowedVideoTypesList,
      maxSize: json['maxSize'],
      previewVideo: json['previewVideo'],
      videoCompression: json['videoCompression'],
      uploadType: json['uploadType'],
      geofenceShape: json['geofenceShape'],
      geofenceTypes: json['geofenceTypes'],
    );
  }
